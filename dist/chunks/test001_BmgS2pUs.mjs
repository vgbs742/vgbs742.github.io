import { c as createAstro, a as createComponent, r as renderTemplate, d as defineScriptVars, g as renderScript, e as addAttribute, b as renderComponent, m as maybeRenderHead } from './astro/server_BrY61_ak.mjs';
import 'kleur/colors';
import '@astrojs/internal-helpers/path';
import { g as getLangFromUrl, a as getSlugNoLangFromUrl } from './handleCollections_dO9PUwyD.mjs';
...
const $$Slider = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a || (_a = __template(["", '<div class="hidden" data-astro-cid-jbob4fnn></div> <div class="hidden aspect-square" data-astro-cid-jbob4fnn></div> <div class="hidden aspect-4/3" data-astro-cid-jbob4fnn></div> <div class="hidden aspect-3/4" data-astro-cid-jbob4fnn></div> <div class="hidden aspect-3/2" data-astro-cid-jbob4fnn></div> <div class="hidden aspect-2/3" data-astro-cid-jbob4fnn></div> <div class="hidden aspect-16/9" data-astro-cid-jbob4fnn></div> <div class="hidden aspect-9/16" data-astro-cid-jbob4fnn></div> <div class="hidden max-h-0" data-astro-cid-jbob4fnn></div> <div class="hidden scale-y-0" data-astro-cid-jbob4fnn></div> <div', "", " data-astro-cid-jbob4fnn> ", ' <!-- Navigation buttons --> <button class="absolute top-1/2 left-4 transform -translate-y-1/2 bg-primary bg-opacity-75 hover:bg-opacity-100 all-neutral-dark rounded-full p-3 shadow-md transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-focus" data-slider-prev data-astro-cid-jbob4fnn> <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-astro-cid-jbob4fnn> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" data-astro-cid-jbob4fnn></path> </svg> </button> <button class="absolute top-1/2 right-4 transform -translate-y-1/2 bg-primary bg-opacity-75 hover:bg-opacity-100 all-neutral-dark rounded-full p-3 shadow-md transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-focus" data-slider-next data-astro-cid-jbob4fnn> <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-astro-cid-jbob4fnn> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" data-astro-cid-jbob4fnn></path> </svg> </button> <!-- indicators and caption --> <div class="flex flex-col flex-wrap absolute bottom-0 w-full transition-all duration-150 ease" data-astro-cid-jbob4fnn> <!-- Slide indicators --> <div class="mx-auto my-2 flex space-x-3 z-10 w-full justify-center" data-astro-cid-jbob4fnn> ', ' </div> <!-- caption --> <div class="caption grid text-sm w-full z-10 h-fit transition-all duration-50 ease-in-out p-3" caption-outer-container data-astro-cid-jbob4fnn> <div class="grid grid-cols-1 grid-rows-1 bg-complementary-opposite-yellow transition-all duration-500 ease-in-out h-fit py-2" caption-inner-container data-astro-cid-jbob4fnn> ', ' </div> </div> </div> </div> <div class="captionMobile text-sm grid w-full z-10 h-fit transition-all duration-50 ease-in-out pb-3 -my-3" caption-outer-container-mobile data-astro-cid-jbob4fnn> <div class="grid grid-cols-1 grid-rows-1 bg-complementary-opposite-yellow transition-all duration-500 ease-in-out h-fit shadow-lg z-50" caption-inner-container-mobile data-astro-cid-jbob4fnn> ', " </div> </div> ", " <script>(function(){", `
...
})();<\/script> `])), maybeRenderHead(), addAttribute("flex flex-col custom-slider relative w-full overflow-hidden shadow-lg my-3 bg-secondary aspect-" + aspect, "class"), addAttribute(sliderId, "id"), items.map((thisImage, index) => renderTemplate`<div class="absolute top-0 left-0 w-full h-full object-cover opacity-0 transition-opacity duration-500 ease-in-out invisible" data-slider-container data-astro-cid-jbob4fnn> ${renderComponent($$result, "Image", $$Image, { "src": thisImage, "alt": thisImage.capAlt.alt || thisImage.data.generic_alt[lang] || "", "class": "absolute medium-zoomable top-0 left-0 w-full h-full object-cover", "data-slider-image": true, "data-index": index, "medium-zoomable": true, "data-astro-cid-jbob4fnn": true })}  </div>`), items.map((_, index) => renderTemplate`<button class="w-3 h-3 rounded-full bg-primary bg-opacity-50 hover:bg-opacity-100 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-focus" style="z-index: 0;" data-slider-indicator${addAttribute(index, "data-index")} data-astro-cid-jbob4fnn></button>`), items.map((thisImage, index) => renderTemplate`<div class="invisible overflow-hidden transition-all ease-in-out duration-300 delay-0 opacity-0 mx-0 mb-0 order-1 px-4 h-0 max-h-8 [grid-area: 1/1/1/1] text-neutral-dark"${addAttribute(index, "data-index")} data-astro-cid-jbob4fnn>${thisImage.capAlt.caption || thisImage.data.generic_caption[lang] || " "}<span class="ref float-right" data-astro-cid-jbob4fnn><a${addAttribute(thisImage.data.source_url, "href")} data-astro-cid-jbob4fnn>${"   by " + thisImage.data.author + ", " + thisImage.data.source_name}</a></span></div>`), items.map((thisImage, index) => renderTemplate`<div class="invisible overflow-hidden transition-all ease-in-out duration-300 delay-0 opacity-0 mx-0 mb-0 order-1 px-4 h-0 max-h-8 [grid-area: 1/1/1/1] text-neutral-dark"${addAttribute(index, "data-index")} data-astro-cid-jbob4fnn>${thisImage.capAlt.caption || thisImage.data.generic_caption[lang] || " "}<span class="ref float-right" data-astro-cid-jbob4fnn><a${addAttribute(thisImage.data.source_url, "href")} data-astro-cid-jbob4fnn>${"    by " + thisImage.data.author + ", " + thisImage.data.source_name}</a></span></div>`), renderScript($$result, "/Users/johann/Documents/code/webdev/Astro/VGBS/vgbs742.github.io/src/components/content/Slider.astro?astro&type=script&index=0&lang.ts"), defineScriptVars({ interval, sliderId, items }));
}, "/Users/johann/Documents/code/webdev/Astro/VGBS/vgbs742.github.io/src/components/content/Slider.astro", void 0);

const AAimg = new Proxy({"src":"/vgbs742.github.io/_astro/test001.DbSD2vN9.jpg","width":4080,"height":3072,"format":"jpg","orientation":1}, {
