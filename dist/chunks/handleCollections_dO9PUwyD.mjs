import { c as createAstro, a as createComponent, r as renderTemplate, e as addAttribute, g as renderScript, f as renderSlot, h as renderHead, b as renderComponent, A as AstroError, R as RenderUndefinedEntryError, u as unescapeHTML, U as UnknownContentCollectionError, i as renderUniqueStylesheet, j as renderScriptElement, k as createHeadAndContent, l as ASTRO_VERSION, N as NoMatchingImport, m as maybeRenderHead, F as Fragment } from './astro/server_BrY61_ak.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_CdNjDrz6.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/vgbs742.github.io", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://vgbs742.github.io/", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_BYbBxHrA.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_CMv379sq.mjs');
...
const $$Menu = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="hidden h-fit"></div> <div class="w-full hidden md:flex flex-row justify-between"> <div class="max-h-24 h-auto"> ${renderComponent($$result, "LogoTop", $$LogoTop, {})} </div> <div class="flex-grow-1"></div> <div class="mx-0 w-fit flex flex-row"> <span class="flex flex-row items-center  flex-grow-1"> ${renderComponent($$result, "Fragment", Fragment, {}, { "default": ($$result2) => renderTemplate`${unescapeHTML(frag4Large)}` })} </span> <span class="flex flex-row items-center"> <!-- &nbsp;&nbsp;&nbsp;• --> <span class="wantLang cursor-pointer flex flex-row  transition-all max-w-36 overflow-hidden">
&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;
${renderComponent($$result, "Fragment", Fragment, {}, { "default": ($$result2) => renderTemplate`${unescapeHTML(lang4Large)}` })} </span> </span> </div> </div> <div class="w-full flex flex-col md:hidden justify-between"> <div class="w-full flex flex-col"> <div class="max-h-24 h-auto"> ${renderComponent($$result, "LogoTop", $$LogoTop, {})} </div> <div class="h-0.2"></div> <div class="h-0.5 bg-secondary w-full" data-aos="fade-up" data-aos-duration="2000"></div> <div class="flex-grow-1"></div> <div class="mx-auto my-1.5 w-fit flex flex-row items-center "> <span>&nbsp;&nbsp;&nbsp;•&nbsp;&nbsp;&nbsp;</span> <a class="cursor-pointer flex-grow-1" id="mobileMenuButton"> ${tNav.menu[lang]} </a> <!--<span>&nbsp;&nbsp;&nbsp;•&nbsp;&nbsp;&nbsp;</span>
...
--- -->${maybeRenderHead()}<section class=""> <div class=""> <!-- <LogoTop /> --> </div> <div class="px-8 2xl:max-w-7xl mx-0 pb-12"> <div class="space-y-0"> <div class="h-0 bg-secondary" data-aos="fade-up" data-aos-duration="1000"></div> <div class="flex flex-col sm:flex-row gap-3 justify-between items-center" data-aos="fade-up" data-aos-duration="1500"> ${renderComponent($$result, "Menu", $$Menu, { "lang": lang })} </div> <div class="h-1.5 bg-secondary hidden w-full md:flex" data-aos="fade-up" data-aos-duration="2000"></div> </div> </div> </section>`;
...
export { $$BaseLayout as $, DEFAULT_HASH_PROPS as D, VALID_SUPPORTED_FORMATS as V, getSlugNoLangFromUrl as a, getSection as b, getOneLang as c, getCollection as d, $$TopArea as e, getTranslations as f, getLangFromUrl as g, getEntry as h, formatDate as i, getPageUrl as j, getItemLang as k, types as l, DEFAULT_OUTPUT_FORMAT as m, renderEntry as r, sortBigFirst as s, typeHandlers as t };
